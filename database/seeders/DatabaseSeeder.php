...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // 4. Categories
        $catElectronics = Category::firstOrCreate(['name' => 'Elektroniki (Electronics)'], ['slug' => 'electronics', 'icon' => '📱']);
        $catFashion = Category::firstOrCreate(['name' => 'Mavazi na Viatu (Fashion & Shoes)'], ['slug' => 'fashion', 'icon' => '👟']);
        $catWatches = Category::firstOrCreate(['name' => 'Saa na Vifaa (Watches & Accessories)'], ['slug' => 'watches', 'icon' => '⌚']);
        $catStationery = Category::firstOrCreate(['name' => 'Vifaa vya Shule na Ofisi (Stationery)'], ['slug' => 'stationery', 'icon' => '📚']);
